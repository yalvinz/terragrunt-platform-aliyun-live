terragrunt = {
  dependencies {
    paths = ["../../slb", "../../slb-listeners/https-443", "../../slb-server-groups/tome-misc"]
  }
  include {
...
# VServer group
slbsg_remote_state_key = "slbs/origin-tome-tokopedia-com/slb-server-groups/tome-misc/terraform.tfstate"
